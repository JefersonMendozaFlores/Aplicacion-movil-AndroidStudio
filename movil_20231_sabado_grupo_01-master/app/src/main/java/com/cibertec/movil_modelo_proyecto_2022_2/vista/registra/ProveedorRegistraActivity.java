...
public class ProveedorRegistraActivity extends NewAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spnPais = findViewById(R.id.spnRegProvePais);
        ...
        spnTipProveedor = findViewById(R.id.spnRegProveTipoProve);
        spnTipProveedor.setAdapter(adaptadorTipoProve);

        cargaListaPais();
        cargaListaTipoProveedor();

        txtRazonSocial = findViewById(R.id.txtRegProveRazonSocial);
        txtRuc = findViewById(R.id.txtRegProveRuc);
        txtDireccion = findViewById(R.id.txtRegProveDirec);
        txtTelFijo = findViewById(R.id.txtRegProveTelf);
        txtTelMov = findViewById(R.id.txtRegProveCel);
        txtContacto = findViewById(R.id.txtRegProveContacto);
        txtFechaRegistro = findViewById(R.id.txtRegProveFechaRegistro);

        btnRegistrar = findViewById(R.id.btnRegistrarProve);
        ...
        btnRegistrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //}else if (!fregi.matches(ValidacionUtil.FECHA)){
                   // mensajeToast("La fecha de creación es YYYY-MM-dd HH:MM:SS");
                    //txtFechaRegistro.setError("La fecha de creación es YYYY-MM-dd HH:MM:SS");
                }else {
